...
/* Hookpoint: ClassContent:Annotations */
 ...
 abstract  public  class ASTTextBlockTOP extends ASTCNode  implements de.monticore.gettingstarted.website._ast.ASTPageContentElement,de.monticore.gettingstarted.website._ast.ASTWebsiteNode {
...
this.paragraphs = paragraphs;
...

 {
    ...
    // We allow a down cast here, because the subclass ASTTextBlock must exist
    ...
    if (this instanceof ASTTextBlock) {
      visitor.handle((ASTTextBlock) this);
    } else {
      throw new UnsupportedOperationException("0xA7011x87547 Only handwritten class ASTTextBlock is supported for the visitor");
    }
...

 {
  ...
  if (visitor instanceof de.monticore.gettingstarted.website._visitor.WebsiteTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x18411 AST node type ASTTextBlock expected a visitor of type de.monticore.gettingstarted.website._visitor.WebsiteTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...

 {
  ...
  if (visitor instanceof de.monticore.gettingstarted.website._visitor.WebsiteTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x14235 AST node type ASTTextBlock expected a visitor of type de.monticore.gettingstarted.website._visitor.WebsiteTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
 ...
 {
    return de.monticore.gettingstarted.website.WebsiteMill.textBlockBuilder().uncheckedBuild();
}
