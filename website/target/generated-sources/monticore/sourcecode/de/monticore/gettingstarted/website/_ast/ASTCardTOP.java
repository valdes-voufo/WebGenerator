...
/* Hookpoint: ClassContent:Annotations */
 ...
 abstract  public  class ASTCardTOP extends ASTCNode  implements de.monticore.gettingstarted.website._ast.ASTPageContentElement,de.monticore.gettingstarted.website._ast.ASTWebsiteNode {
...
// empty body
...

 {
    ...
    if (!equalAttributes(comp)) {
     ...
     // comparing paragraph
     if ( (this.paragraph == null && comp.paragraph != null) ||
        (this.paragraph != null && !this.paragraph.deepEquals(comp.paragraph, forceSameOrder)) ) {
        return false;
     }
    return true;     
...

 {
    ...
    if (!equalsWithComments(comp)) {
      ...
      // comparing paragraph
      if ( (this.paragraph == null && comp.paragraph != null) ||
        (this.paragraph != null && !this.paragraph.deepEqualsWithComments(comp.paragraph, forceSameOrder)) ) {
        return false;
      }
    return true;     
...

 {
	...
	// comparing link 
    if ( (this.link == null && comp.link != null) 
      || (this.link != null && !this.link.equals(comp.link)) ) {
      return false;
    }
    return true;
...

 {
  ...
  for (de.monticore.ast.Comment x : get_PostCommentList()) {
    result.get_PostCommentList().add(new de.monticore.ast.Comment(x.getText()));
      ...
      result.setParagraph(getParagraph().deepClone());
...
this.link = link;
...

 {
    ...
    // We allow a down cast here, because the subclass ASTCard must exist
    ...
    if (this instanceof ASTCard) {
      visitor.handle((ASTCard) this);
    } else {
      throw new UnsupportedOperationException("0xA7011x18283 Only handwritten class ASTCard is supported for the visitor");
    }
...

 {
  ...
  if (visitor instanceof de.monticore.gettingstarted.website._visitor.WebsiteTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x96033 AST node type ASTCard expected a visitor of type de.monticore.gettingstarted.website._visitor.WebsiteTraverser, but got de.monticore.mcbasics._visitor.MCBasicsTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...

 {
  ...
  if (visitor instanceof de.monticore.gettingstarted.website._visitor.WebsiteTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x35617 AST node type ASTCard expected a visitor of type de.monticore.gettingstarted.website._visitor.WebsiteTraverser, but got de.monticore.literals.mcliteralsbasis._visitor.MCLiteralsBasisTraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
...

 {
  ...
  if (visitor instanceof de.monticore.gettingstarted.website._visitor.WebsiteTraverser) {
    ...
    de.se_rwth.commons.logging.Log.error("0xA7000x99567 AST node type ASTCard expected a visitor of type de.monticore.gettingstarted.website._visitor.WebsiteTraverser, but got de.monticore.visitor.ITraverser. Visitors of a super language may not be used on ASTs containing nodes of the sub language. Use a visitor of the sub language.");
  }
 ...
 {
    return de.monticore.gettingstarted.website.WebsiteMill.cardBuilder().uncheckedBuild();
}
